...
- the current delivery form is a small full web application with a Node.js backend, a simple frontend, authenticated sessions, and database persistence
...
The current system is implemented as a small Node.js web application.

At this stage:

- the backend exposes the claim behavior through HTTP endpoints
...
- persistence is SQLite-backed and survives application restarts
