...
- Python web routes for explicit rejected-claim reopening plus preserved review history
- Persistence for historical review cycles
- Server-rendered employee flow for reopening, editing, resubmitting, and viewing review history
