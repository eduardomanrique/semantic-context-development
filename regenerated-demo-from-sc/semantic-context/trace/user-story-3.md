...
- Python web routes for finance claim queue, claim detail, and payment action
- SQLite schema for paid state plus payment metadata
- Server-rendered finance flow for approved-claim inspection and payment completion
